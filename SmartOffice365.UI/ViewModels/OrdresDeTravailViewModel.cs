    ...
    public class OrdresDeTravailViewModel : ViewModelBase
    {
        ...
        private void LoadMockData()
        {
            ...
            var mock = new List<OrdreDeTravailEntity>
            {
                ...
                new() { Id=2, NumeroOT_Aufnr="40001235", Titre="Consignation Électrique TGBT-02", StatutShutdown="Terminé", Priorite="Haute", Avancement=100, Responsable="M. Martin", NumeroEquipement_EQUNR="EQ-1002", PosteTechnique_TPLNR="U100-EL-02", PosteTravail_ARBPL="ELECTR" },
                new() { Id=3, NumeroOT_Aufnr="40001236", Titre="Épreuve Hydraulique Réacteur R-201", StatutShutdown="En cours", Priorite="Critique", Avancement=65, Responsable="P. Lefebvre", NumeroEquipement_EQUNR="EQ-3301", PosteTechnique_TPLNR="U200-RX-01", PosteTravail_ARBPL="INSPECTION" },
                new() { Id=4, NumeroOT_Aufnr="40001237", Titre="Contrôle Ultrasons Soudures Tuyauterie", StatutShutdown="En cours", Priorite="Normale", Avancement=40, Responsable="A. Bernard", NumeroEquipement_EQUNR="EQ-4410", PosteTechnique_TPLNR="U100-PIP-05", PosteTravail_ARBPL="TUYAUTERIE" },
                new() { Id=5, NumeroOT_Aufnr="40001238", Titre="Nettoyage Chimique Échangeur E-104", StatutShutdown="À Faire", Priorite="Normale", Avancement=0, Responsable="C. Thomas", NumeroEquipement_EQUNR="EQ-2204", PosteTechnique_TPLNR="U100-EX-04", PosteTravail_ARBPL="NETTOYAGE" },
                new() { Id=6, NumeroOT_Aufnr="40001239", Titre="Remplacement Garniture Pompe P-302B", StatutShutdown="Bloqué", Priorite="Haute", Avancement=10, Responsable="J. Dupont", MotifsBlockage="Habilitation ATEX prestataire expirée", NumeroEquipement_EQUNR="EQ-5002", PosteTechnique_TPLNR="U300-P-02", PosteTravail_ARBPL="MECANIK" },
            };
